...
CREATE TABLE `category_tab` (
  `category_no` int(11) NOT NULL AUTO_INCREMENT COMMENT 'KEY^QRY^',
  `category_name` varchar(200) NOT NULL COMMENT 'QRY^',
...
INSERT INTO `category_tab` VALUES (1,'Emultion'),(2,'Whethercoat');
