...
CREATE TABLE `purchase_order_tab` (
  ...
  `date` varchar(50) DEFAULT NULL COMMENT 'QRY^',
  `remarks` varchar(500) DEFAULT NULL COMMENT 'QRY^',
  `inv_value` decimal(10,0) DEFAULT '0' COMMENT 'QRY^',
  `status` varchar(45) DEFAULT 'Planned' COMMENT 'QRY^',
...
INSERT INTO `purchase_order_tab` VALUES ('P00001','2016-5-7','Test Remark 1',0,'Planned');
